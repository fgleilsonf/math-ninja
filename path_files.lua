...
function getImage()
    return {
        PATH_IMAGE_BALL_RED_ = PATH_BASE_IMAGES_.."ball_red.png",
        ...
        PATH_IMAGE_BALL_BLUE_ = PATH_BASE_IMAGES_.."ball_blue.png",
        ...
        PATH_IMAGE_BALL_YELLOW_ = PATH_BASE_IMAGES_.."ball_yellow.png",
